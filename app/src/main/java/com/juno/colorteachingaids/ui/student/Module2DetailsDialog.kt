    ...
    Dialog(onDismissRequest = onDismiss) {
        Card {
            Column(modifier = Modifier.padding(16.dp)) {
                ...
                Text("Module 2: Mix & Create (Color Mixing)", style = MaterialTheme.typography.headlineSmall, fontWeight = FontWeight.Bold)
                Spacer(modifier = Modifier.height(16.dp))
                Text("Module Overview", style = MaterialTheme.typography.titleMedium, fontWeight = FontWeight.Bold)
                Text("This activity helps students discover how primary colors mix to create secondary colors.")
                Spacer(modifier = Modifier.height(16.dp))
                Text("Best For", style = MaterialTheme.typography.titleMedium, fontWeight = FontWeight.Bold)
                Text("• Students who have mastered basic color recognition")
                Text("• Learners who benefit from cause-and-effect exploration")
                Text("• Students with autism or attention challenges")
                Spacer(modifier = Modifier.height(16.dp))
                Text("IEP Alignment", style = MaterialTheme.typography.titleMedium, fontWeight = FontWeight.Bold)
                Text("\"Student will demonstrate understanding of color mixing.\"")
                Spacer(modifier = Modifier.height(16.dp))
                ...
                Text("• Use Slow animation for processing delays")
...
@Preview
@Composable
fun Module2DetailsDialogPreview() {
    ColorTeachingAidsTheme {
        Module2DetailsDialog(onDismiss = {})
    }
}
