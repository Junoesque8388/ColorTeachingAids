...
fun Module3Help(
    onDismiss: () -> Unit,
    onShowDemo: () -> Unit,
    viewModel: Module1HelpViewModel = hiltViewModel() // Re-using for TTS, can be improved
) {
    val helpText = """
        1. Look at the picture of the object.

        2. Read the question: "What color is this...?"

        3. Tap on the colored circle that matches the object.

        If you are correct, the picture will change to color!
    """
...
@Preview
@Composable
fun Module3HelpPreview() {
    ColorTeachingAidsTheme {
        Module3Help(onDismiss = {}, onShowDemo = {})
    }
}
